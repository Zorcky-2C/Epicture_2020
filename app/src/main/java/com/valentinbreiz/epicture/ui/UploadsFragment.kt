...
class UploadsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var root = inflater.inflate(R.layout.fragment_uploads, container, false)

        recyclerView = root.findViewById<View>(R.id.recycler_view_uploads) as RecyclerView
        ...
        val pullToRefresh: SwipeRefreshLayout = root.findViewById(R.id.swiperefreshuploads)
        ...
        recyclerView!!.addOnItemTouchListener(GalleryAdapter.RecyclerTouchListener(root.context, recyclerView!!, object : GalleryAdapter.ClickListener {
            ...
            override fun onLongClick(view: View?, position: Int) {
                AsyncAction({
                    return@AsyncAction Imgur.deleteImage(images!![position].deleteHash!!)
                }, {
    ...
    fun fetchData() {
        ...
        pDialog!!.show()
        val jsonObjectRequest: JsonObjectRequest = object : JsonObjectRequest(Method.GET, "https://api.imgur.com/3/account/me/images", null, Response.Listener { response ->
            ...
            try {
                ...
                for (i in 0 until items.length()) {
                    ...
                    photo.deleteHash = item.getString("deletehash")
